...
[Streamlit App Link](https://sourabhsonker-bank-churn-predictor.streamlit.app/) &nbsp;
...
├── requirements.txt
├── 01_eda_and_feature_engineering.ipynb   <- Exploratory Data Analysis and Feature Engineering
